#!/usr/bin/env python3
"""
Standalone script to run the Odoo v9 MCP server with enhanced logging
...
def main() -> int:
    """
    Run the MCP server with FastMCP 3.x
    """
    logger = setup_logging()

    try:
        logger.info("=== ODOO V9 MCP SERVER STARTING ===")
        ...
        logger.info("Starting Odoo v9 MCP server with FastMCP run() method...")
        sys.stderr.flush()
        ...
        logger.info("Odoo v9 MCP server stopped by user")
        return 0
