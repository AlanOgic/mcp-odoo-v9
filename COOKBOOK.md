...
uv --directory /absolute/path/of/mcp-odoo-v9 odoo-mcp-v9
uvx --no-cache --directory /absolute/path/of/mcp-odoo-v9 odoo-mcp-v9
python -m odoo_mcp
...
```python
# (city=Paris OR city=Lyon) AND customer=true
execute_method(
    model="res.partner",
    method="search_read",
    args_json='[[
...
execute_method(
    ...
    args_json='[[123], "invoice_open"]'  # Invoice ID
```
...
execute_method(
    ...
    args_json='[[
        ...
        ["date_invoice", "<=", "2025-03-31"],
        ["state", "=", "open"]
    ]]',
    kwargs_json='{"fields": ["number", "partner_id", "date_invoice", "amount_total"]}'
)
```
