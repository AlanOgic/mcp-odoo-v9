# Odoo v9 MCP Server - User Guide

**Control your Odoo v9 ERP with AI - Two tools. Infinite possibilities.**
...
- **Odoo instance**: Version 9 (on-premise)
- **Odoo credentials**: Username and password
...
- `ODOO_PASSWORD` is your user password
...
```json
{
  "mcpServers": {
    "odoo": {
      "command": "python3",
      "args": ["-m", "odoo_mcp"],
      "cwd": "/absolute/path/to/mcp-odoo-v9",
      "env": {
        "ODOO_URL": "https://your-instance.odoo.com",
        "ODOO_DB": "your-database-name",
        "ODOO_USERNAME": "your-email@company.com",
...
**Replace** `/absolute/path/to/mcp-odoo-v9` with your actual project path (e.g., `/Users/yourname/projects/mcp-odoo-v9`).
...
- **Issues**: [GitHub Issues](https://github.com/AlanOgic/mcp-odoo-v9/issues)
- **Discussions**: [GitHub Discussions](https://github.com/AlanOgic/mcp-odoo-v9/discussions)
...
3. Confirm the database name matches exactly
